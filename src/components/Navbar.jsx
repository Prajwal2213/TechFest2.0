        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="flex items-center cursor-pointer">
            <Link to="/" className="flex items-center  md:gap-4">
              <img src="https://res.cloudinary.com/dstbnmjwh/image/upload/v1771870025/Techfest_logo-removebg-preview_xikawj.png" alt="TechFest logo" className="w-auto h-20 lg:h-16  scale-100 md:scale-150 mr-7" />
