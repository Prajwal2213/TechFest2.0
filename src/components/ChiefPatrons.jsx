  ...
  return url.replace(
    ...
    return(
      ...
      <div className="relative z-1 grid grid-cols-1 md:grid-cols-3 gap-10 mb-10 md:ml-70 ">
        {[
            { name: 'Dr. D. HEMACHANDRA SAGAR', desc: 'Chancellor, DSU', img: optimize('/images/Chief_patrons/drhemachandra.jpeg') },
            { name: 'Dr. D. PREMACHANDRA SAGAR', desc: 'Pro Chancellor, DSU', img: optimize('/images/Chief_patrons/drpremachandra.jpeg') },
        ].map((person, index) => (
