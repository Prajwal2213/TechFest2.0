...
const CheifPatrons = () => {
    return(
      ...
      <div className="relative z-1 grid grid-cols-1 md:grid-cols-3 gap-10 mb-10 ml-70 ">
        {[
            ...
            // { name: 'Dr. Sudarshan TSB', desc: ' Dean Research, DSU', img: '/committee/Dr.Sudarshan_TSB.jpg' },
