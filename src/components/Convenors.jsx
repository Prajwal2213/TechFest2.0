  ...
  return (
     <div className="flex justify-center">
      <div className="relative z-1 grid grid-cols-1 md:grid-cols-3 gap-10 mb-10 ">
        {[
            { name: 'Dr. Arun Balodi', desc: 'Chairman & Professor (Electronics and communication Engineering)', img: './images/Convenors/Dr_arun_Balodi.jpeg' },
            { name: 'Dr. Shaila S. G', desc: ' Professor and Chairperson CSE(Data Science)', img: './images/Convenors/dr_Shaila.jpg' },
            { name: 'Dr. Nagaraja S. R', desc: ' Professor and Chairperson (Aerospace Engineering)', img: './images/Convenors/snsr.png' },
