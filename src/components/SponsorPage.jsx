const SponsorPage = () => {
  const sponsorTiers = [
    {
      ...
      logos: [
        "https://res.cloudinary.com/dstbnmjwh/image/upload/v1771434566/mav_aadyy9.webp",
      ...
      desc:"Explore Maven Silicon’s website to gain hands-on workshop experience in VLSI and Embedded Systems.",
      webURL: "https://www.maven-silicon.com/"
    },
    // {
      ...
      <section className="relative z-10 py-16 sm:py-24 px-4 sm:px-8 lg:px-24 text-center w-full font-Orbitron mt-20">
        ...
        {sponsorTiers.map((tier, idx) => (
          <div key={idx} className="mb-16">
            <h2 className="text-cyan-400 text-2xl sm:text-3xl md:text-6xl font-semibold mb-10 tracking-wide uppercase">
              {tier.title}
            </h2>
 ...
 <div>
    <p className="mt-10 text-sm sm:text-base text-white/40 max-w-2xl mx-auto">
      {tier.desc}
    </p>
  </div>
  </div>
